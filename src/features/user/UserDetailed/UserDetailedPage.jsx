      ...
      if(loading) return <LoadingComponent inverted={true} />
        return (
            <Grid>
              ...
              <UserDetailedSidebar isFollowing={isFollowing} profile={profile} followUser={followUser} unfollowUser={unfollowUser} isCurrentUser={isCurrentUser}/>
...
export default compose(
  ...
  firestoreConnect((auth,userUid, match) => userDetailQuery(auth, userUid)),
)(UserDetailedPage);
